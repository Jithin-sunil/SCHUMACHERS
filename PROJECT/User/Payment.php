...
if (isset($_POST["btn_pay"])) {
    ...
    $a = "update tbl_request set request='4' where request_id='" . $_GET["cid"] . "'";
    if ($Conn->query($a)) {
...
<body>
    <div class="wrapper">
        ...
        <form method="POST">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="checkbox" name="chk_box" id="chk_box" required />I Agree to all <a
                        href="Termsandconditions.php">Terms and conditions</a>
                </div>
